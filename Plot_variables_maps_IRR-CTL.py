...
data_E_NOI = Data_from_nc('E:\Research1\\CTL\EFLX_LH_TOT_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('E:\Research1\\IRR\EFLX_LH_TOT_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('E:\Research1\\CTL\FSH_timmean.nc')   #load the data
data_variable_E_NOI = data_E_NOI.load_variable('FSH')
data_variable_E_NOI[data_variable_E_NOI >= 10000000000] = None
data_variable_E_NOI = data_variable_E_NOI[0, :, :]
data_variable_E_NOI = data_variable_E_NOI[29 :, :]

data_E_IRR = Data_from_nc('E:\Research1\\IRR\FSH_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('E:\Research1\\CTL\SWup_timmean.nc')   #load the data
data_variable_E_NOI = data_E_NOI.load_variable('SWup')
data_variable_E_NOI[data_variable_E_NOI >= 10000000000] = None
data_variable_E_NOI = data_variable_E_NOI[0, :, :]
data_variable_E_NOI = data_variable_E_NOI[29 :, :]

data_E_IRR = Data_from_nc('E:\Research1\\IRR\SWup_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('E:\Research1\\CTL\LWup_timmean.nc')   #load the data
data_variable_E_NOI = data_E_NOI.load_variable('LWup')
data_variable_E_NOI[data_variable_E_NOI >= 10000000000] = None
data_variable_E_NOI = data_variable_E_NOI[0, :, :]
data_variable_E_NOI = data_variable_E_NOI[29 :, :]

data_E_IRR = Data_from_nc('E:\Research1\\IRR\LWup_timmean.nc')   #load the data
...
plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\Energy2.png')

f = plt.figure(figsize = (12, 8), dpi=100)  # initiate the figure
set_plot_param()

data_E_NOI = Data_from_nc('E:\Research1\\CTL\Qle_timmean.nc')   #load the data
data_variable_E_NOI = data_E_NOI.load_variable('Qle')
data_variable_E_NOI[data_variable_E_NOI >= 10000000000] = None
data_variable_E_NOI = data_variable_E_NOI[0, :, :]
data_variable_E_NOI = data_variable_E_NOI[29 :, :] / 28.94 * 365

data_E_IRR = Data_from_nc('E:\Research1\\IRR\Qle_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('E:\Research1\\CTL\QVEGT_timmean.nc')   #load the data
data_variable_E_NOI = data_E_NOI.load_variable('QVEGT')
data_variable_E_NOI[data_variable_E_NOI >= 10000000000] = None
data_variable_E_NOI = data_variable_E_NOI[0, :, :]
data_variable_E_NOI = data_variable_E_NOI[29 :, :] * 31536000

data_E_IRR = Data_from_nc('E:\Research1\\IRR\QVEGT_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('E:\Research1\\CTL\QRUNOFF_timmean.nc')   #load the data
data_variable_E_NOI = data_E_NOI.load_variable('QRUNOFF')
data_variable_E_NOI[data_variable_E_NOI >= 10000000000] = None
data_variable_E_NOI = data_variable_E_NOI[0, :, :]
data_variable_E_NOI = data_variable_E_NOI[29 :, :] * 31536000

data_E_IRR = Data_from_nc('E:\Research1\\IRR\QRUNOFF_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('E:\Research1\\CTL\TOTSOILLIQ_timmean.nc')   #load the data
data_variable_E_NOI = data_E_NOI.load_variable('TOTSOILLIQ')
data_variable_E_NOI[data_variable_E_NOI >= 10000000000] = None
data_variable_E_NOI = data_variable_E_NOI[0, :, :]
data_variable_E_NOI = data_variable_E_NOI[29 :, :]

data_E_IRR = Data_from_nc('E:\Research1\\IRR\TOTSOILLIQ_timmean.nc')   #load the data
...
plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\Water2.png')