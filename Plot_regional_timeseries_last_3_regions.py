...
plot_var(ax1, x, WNA_IRR_EFLX_LH_TOT, WNA_CTL_EFLX_LH_TOT, WNA_NOI_EFLX_LH_TOT, 'upper left', r'LHF ($W/m^2$)', 'Latent heat flux', 'a', 'MED')

ax1 = plt.subplot(3, 4, 2)
plot_var_nolegend(ax1, x, WNA_IRR_FSH, WNA_CTL_FSH, WNA_NOI_FSH, 'upper left', r'SHF ($W/m^2$)', 'Sensible heat flux', 'b', 'MED')

ax1 = plt.subplot(3, 4, 3)
plot_var_nolegend(ax1, x, WNA_IRR_LWup, WNA_CTL_LWup, WNA_NOI_LWup, 'upper left', r'LWup ($W/m^2$)', 'Upwelling longwave radiation', 'c', 'MED')

ax1 = plt.subplot(3, 4, 4)
plot_var_nolegend(ax1, x, WNA_IRR_SWup, WNA_CTL_SWup, WNA_NOI_SWup, 'upper left', r'SWup ($W/m^2$)', 'Upwelling shortwave radiation', 'd', 'MED')
...
plot_var_nolegend(ax1, x, WNA_IRR_EFLX_LH_TOT, WNA_CTL_EFLX_LH_TOT, WNA_NOI_EFLX_LH_TOT, 'upper left', r'LHF ($W/m^2$)', 'Latent heat flux', 'e', 'EAS')

ax1 = plt.subplot(3, 4, 6)
plot_var_nolegend(ax1, x, WNA_IRR_FSH, WNA_CTL_FSH, WNA_NOI_FSH, 'upper left', r'SHF ($W/m^2$)', 'Sensible heat flux', 'f', 'EAS')

ax1 = plt.subplot(3, 4, 7)
plot_var_nolegend(ax1, x, WNA_IRR_LWup, WNA_CTL_LWup, WNA_NOI_LWup, 'upper left', r'LWup ($W/m^2$)', 'Upwelling longwave radiation', 'g', 'EAS')

ax1 = plt.subplot(3, 4, 8)
plot_var_nolegend(ax1, x, WNA_IRR_SWup, WNA_CTL_SWup, WNA_NOI_SWup, 'upper left', r'SWup ($W/m^2$)', 'Upwelling shortwave radiation', 'h', 'EAS')
...
plot_var_nolegend(ax1, x, WNA_IRR_EFLX_LH_TOT, WNA_CTL_EFLX_LH_TOT, WNA_NOI_EFLX_LH_TOT, 'upper left', r'LHF ($W/m^2$)', 'Latent heat flux', 'i', 'SEA')

ax1 = plt.subplot(3, 4, 10)
plot_var_nolegend(ax1, x, WNA_IRR_FSH, WNA_CTL_FSH, WNA_NOI_FSH, 'upper left', r'SHF ($W/m^2$)', 'Sensible heat flux', 'j', 'SEA')

ax1 = plt.subplot(3, 4, 11)
plot_var_nolegend(ax1, x, WNA_IRR_LWup, WNA_CTL_LWup, WNA_NOI_LWup, 'upper left', r'LWup ($W/m^2$)', 'Upwelling longwave radiation', 'k', 'SEA')

ax1 = plt.subplot(3, 4, 12)
plot_var_nolegend(ax1, x, WNA_IRR_SWup, WNA_CTL_SWup, WNA_NOI_SWup, 'upper left', r'SWup ($W/m^2$)', 'Upwelling shortwave radiation', 'l', 'SEA')

plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\Timeseries_energy2.png')
...
x = range(1, 13)
ax1 = plt.subplot(3, 4, 1)
plot_var(ax1, x, WNA_IRR_Qle, WNA_CTL_Qle, WNA_NOI_Qle, 'upper left', r'E ($mm/day$)', 'Evaporation', 'a', 'MED')

ax1 = plt.subplot(3, 4, 2)
plot_var_nolegend(ax1, x, WNA_IRR_QVEGT, WNA_CTL_QVEGT, WNA_NOI_QVEGT, 'upper left', r'TR ($mm/day$)', 'Transpiration', 'b', 'MED')

ax1 = plt.subplot(3, 4, 3)
plot_var_nolegend(ax1, x, WNA_IRR_QRUNOFF, WNA_CTL_QRUNOFF, WNA_NOI_QRUNOFF, 'upper left', r'R ($mm/day$)', 'Runoff', 'c', 'MED')

ax1 = plt.subplot(3, 4, 4)
plot_var_nolegend(ax1, x, WNA_IRR_TOTSOILLIQ, WNA_CTL_TOTSOILLIQ, WNA_NOI_TOTSOILLIQ, 'upper left', r'TSW ($kg/m^2$)', 'Total soil water', 'd', 'MED')
...
x = range(1, 13)
ax1 = plt.subplot(3, 4, 5)
plot_var_nolegend(ax1, x, WNA_IRR_Qle, WNA_CTL_Qle, WNA_NOI_Qle, 'upper left', r'E ($mm/day$)', 'Evaporation', 'e', 'EAS')

ax1 = plt.subplot(3, 4, 6)
plot_var_nolegend(ax1, x, WNA_IRR_QVEGT, WNA_CTL_QVEGT, WNA_NOI_QVEGT, 'upper left', r'TR ($mm/day$)', 'Transpiration', 'f', 'EAS')

ax1 = plt.subplot(3, 4, 7)
plot_var_nolegend(ax1, x, WNA_IRR_QRUNOFF, WNA_CTL_QRUNOFF, WNA_NOI_QRUNOFF, 'upper left', r'R ($mm/day$)', 'Runoff', 'g', 'EAS')

ax1 = plt.subplot(3, 4, 8)
plot_var_nolegend(ax1, x, WNA_IRR_TOTSOILLIQ, WNA_CTL_TOTSOILLIQ, WNA_NOI_TOTSOILLIQ, 'upper left', r'TSW ($kg/m^2$)', 'Total soil water', 'h', 'EAS')
...
x = range(1, 13)
ax1 = plt.subplot(3, 4, 9)
plot_var_nolegend(ax1, x, WNA_IRR_Qle, WNA_CTL_Qle, WNA_NOI_Qle, 'upper left', r'E ($mm/day$)', 'Evaporation', 'i', 'SEA')

ax1 = plt.subplot(3, 4, 10)
plot_var_nolegend(ax1, x, WNA_IRR_QVEGT, WNA_CTL_QVEGT, WNA_NOI_QVEGT, 'upper left', r'TR ($mm/day$)', 'Transpiration', 'j', 'SEA')

ax1 = plt.subplot(3, 4, 11)
plot_var_nolegend(ax1, x, WNA_IRR_QRUNOFF, WNA_CTL_QRUNOFF, WNA_NOI_QRUNOFF, 'upper left', r'R ($mm/day$)', 'Runoff', 'k', 'SEA')

ax1 = plt.subplot(3, 4, 12)
plot_var_nolegend(ax1, x, WNA_IRR_TOTSOILLIQ, WNA_CTL_TOTSOILLIQ, WNA_NOI_TOTSOILLIQ, 'upper left', r'TSW ($kg/m^2$)', 'Total soil water', 'l', 'SEA')
plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\Timeseries_water2.png')
#plt.show()
