...
data_E_IRR = Data_from_nc('E:\Research1\\IRR_satu\EFLX_LH_TOT_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('E:\Research1\\IRR_satu\FSH_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('E:\Research1\\IRR_satu\SWup_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('E:\Research1\\IRR_satu\LWup_timmean.nc')   #load the data
...
plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\Energy.png')
...
data_E_IRR = Data_from_nc('E:\Research1\\IRR_satu\Qle_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('E:\Research1\\IRR_satu\QVEGT_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('E:\Research1\\IRR_satu\QRUNOFF_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('E:\Research1\\IRR_satu\TOTSOILLIQ_timmean.nc')   #load the data
...
plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\Water.png')